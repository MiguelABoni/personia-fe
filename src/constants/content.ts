const HOME_TITLE = `Accede a detalles claves sobre los casos de vulnerabilidad que se presentan en Medellín`;
...
const TABLES_DESCRIPTION = `Cada una de estas opciones te mostrará información relacionada con los casos de vulnerabilidad que llegan a diario a la Personería de Medellín y allí podrás encontrar algunos elementos que evidencian el resultado del trabajo arduo que realiza día a día esta entidad buscando siempre el bienestar de quienes necesitan ayuda`;
