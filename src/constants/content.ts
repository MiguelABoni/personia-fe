...
datos e inteligencia artificial y fue creada con la intención de
ayudar a la Personería de Medellín en su proceso de toma de
decisiones frente a los casos de vulnerabilidad que se presentan a
diario en la ciudad. Se encuentra abierta al público y está
esperando que seas tú quien le eche un vistazo...`;
const GRAPHICS_DESCRIPTION = `Cada una de estas opciones te mostrará información relacionada con los casos de vulnerabilidad que llegan a diario a la Personería de Medellín y allí podrás encontrar algunos elementos como nube de palabras o diagramas que representan los temas más comunes y relevantes.`;
const TABLES_DESCRIPTION = `Cada una de estas opciones te mostrará información relacionada con los casos de vulnerabilidad que llegan a diario a la Personería de Medellín y allí podrás encontrar algunos elementos que evidencian el resultado del trabajo arduo que realiza día a día esta entidad, buscando siempre el bienestar de quienes lo necesitan.`;
const TABLES_DETAIL_DESCRIPTION = `La siguiente tabla proporciona una visión general de los temas tratados de manera recurrente y su respectiva cantidad de soluciones.`;
const N_GRAMAS_DESCRIPTION = `Imagina que estás leyendo un libro y quieres saber qué palabras aparecen juntas con frecuencia. Los n-gramas son como fragmentos de palabras o letras que se agrupan de acuerdo con la cantidad que elijas (n), y nos ayudan a entender qué palabras tienden a ir juntas con frecuencia. ¡Es como armar un rompecabezas con las palabras de un libro para ver qué combinaciones son las más comunes!`;
...
const EVENTS_DESCRIPTION = `La primera gráfica es una representación de tiempo que muestra los temas más mencionados por día, los cuales han sido identificados como los más concurrentes, tales como EPS, SAVIA y SURA. Las tres gráficas restantes muestran los mismos temas pero ya mencionados a lo largo del año.`;
...
export const CONTENT = {
  ...
  TABLES_DESCRIPTION,
  TABLES_DETAIL_DESCRIPTION,
  N_GRAMAS_DESCRIPTION,
